...
For removing the "NA2s we can use: na.rm = TRUE
If what we want does not have the "na.rm" we could use: vector[!is.na()], so it will take everything that is not NA. 
