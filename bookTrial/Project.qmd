...
# Determine the type based on the Chain lenght
...
TESTINGB$Chain_length <- paste("C",sub(".*-C(9|10|11|12|13|14|15|16|17)$", "\\1", TESTINGB$"Molecule List")) #Change the column chain Lengthcolumn so it fits the following script and the one of the standards
...
#Grouping samples for creating one data frame for each
...
### Run the deconvolution for all the samples:
```{r}
